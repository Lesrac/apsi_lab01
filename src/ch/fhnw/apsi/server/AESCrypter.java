...
public class AESCrypter {
	...
	public static String encrypt(String value, File keyFile)
		...
		if (!keyFile.exists()) {
			KeyGenerator keyGen = KeyGenerator.getInstance(AESCrypter.AES);
			keyGen.init(128);
		...
		Cipher cipher = Cipher.getInstance(AESCrypter.AES);
	...
	private static SecretKeySpec getSecretKeySpec(File keyFile)
		...
		SecretKeySpec sks = new SecretKeySpec(key, AESCrypter.AES);
		return sks;
	}
